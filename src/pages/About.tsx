    ...
    <div className="min-h-screen warm-gradient text-text-primary px-4 md:px-6 py-12 md:py-20 lg:py-24">
      <div className="max-w-4xl mx-auto space-y-16 md:space-y-24">
        ...
        <div className="text-center space-y-6">
          <Badge variant="accent" className="mb-4 rounded-full">Our Mission</Badge>
        ...
        <motion.div initial={{opacity:0, y:20}} whileInView={{opacity:1, y:0}} viewport={{once:true}} transition={{duration: 0.5}}>
          <Card className="bg-bg shadow-sm border-border/50 relative overflow-hidden">
            ...
            <CardBody className="p-8 md:p-12 relative z-10">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-xl bg-accent-light/50 flex items-center justify-center text-accent">
                  <Target size={24} />
                </div>
              ...
              <div className="space-y-6 text-[16px] md:text-[18px] text-text-secondary leading-relaxed max-w-3xl">
                ...
                <p>
                  That is why we built this platform — to consolidate verified practices, structured training courses, and a community of like-minded builders who share what actually works.
                </p>
              </div>
            </CardBody>
          </Card>
        ...
        <div className="space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <motion.div initial={{opacity:0, y:20}} whileInView={{opacity:1, y:0}} viewport={{once:true}} transition={{duration: 0.5, delay: 0.1}}>
              <Card className="h-full bg-bg shadow-sm hover:shadow-md transition-shadow border-border/50" hover>
                <CardBody className="p-8 flex flex-col items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-amber-light text-amber flex items-center justify-center">
                    <Briefcase size={24} />
                  </div>
            ...
            <motion.div initial={{opacity:0, y:20}} whileInView={{opacity:1, y:0}} viewport={{once:true}} transition={{duration: 0.5, delay: 0.2}}>
              <Card className="h-full bg-bg shadow-sm hover:shadow-md transition-shadow border-border/50" hover>
                <CardBody className="p-8 flex flex-col items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-emerald-light text-emerald flex items-center justify-center">
                    <Zap size={24} />
                  </div>
        ...
        <motion.div initial={{opacity:0, scale:0.95}} whileInView={{opacity:1, scale:1}} viewport={{once:true}} transition={{duration: 0.4}}>
          <div className="text-center p-12 md:p-16 rounded-[32px] bg-ink-900 text-white relative overflow-hidden">
             ...
             <div className="relative z-10 flex flex-col items-center">
               ...
               <p className="text-[18px] text-white/70 mb-8 max-w-lg mx-auto">
                 Join a community of forward-thinking builders and unlock access to lessons, prompts, and exclusive events.
               </p>
               <Button size="lg" onClick={() => openModal('signup')} className="gap-2 px-8 h-14 bg-white text-ink-900 hover:bg-bg-subtle rounded-full text-[16px]">
