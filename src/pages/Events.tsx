          ...
          {EVENTS_DATA.length === 0 ? (
            ...
            return (
              <motion.div 
                ...
                key={e.id}
              >
                <Card className="bg-bg transition-shadow hover:shadow-md border-border-strong group overflow-hidden relative">
                  ...
                  <CardBody className="p-6 md:p-8 flex flex-col md:flex-row gap-6 md:gap-10 items-start md:items-center">
                    ...
                    <div className={`flex flex-col items-center justify-center shrink-0 w-24 h-24 rounded-2xl border transition-colors ${
                      isJoined 
                        ...
                        : 'bg-bg-subtle border-border text-ink-900 group-hover:bg-bg group-hover:border-accent/20'
                    }`}>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap gap-2 mb-3">
                        {isJoined ? (
                          <Badge variant="success" className="gap-1 px-2"><CheckCircle2 size={12} /> Registered</Badge>
                        ) : (
                          <Badge variant="neutral">Upcoming</Badge>
                        )}
                        <Badge variant="neutral" className="gap-1.5 opacity-80 border-dashed">
                      ...
                      <div className="flex flex-wrap gap-4 text-[13px] font-medium text-text-tertiary bg-bg-subtle rounded-lg px-4 py-3 inline-flex items-center">
